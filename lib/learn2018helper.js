  ...
  async login() {
    try {
      const $ = await rp({
        ...
        form: {i_user: this.username, i_pass: this.password, atOne: true},
        jar: this.cookies,
        transform: (body) => {
  ...
  async getDocuments(course) {
    try {
      const resp = await rp({
        ...
        form: {
          aoData:
              `[{"name":"sEcho","value":1},{"name":"iColumns","value":6},{"name":"sColumns","value":",,,,,"},{"name":"iDisplayStart","value":0},{"name":"iDisplayLength","value":3},{"name":"mDataProp_0","value":"wz"},{"name":"bSortable_0","value":true},{"name":"mDataProp_1","value":"bt"},{"name":"bSortable_1","value":true},{"name":"mDataProp_2","value":"wjlx"},{"name":"bSortable_2","value":true},{"name":"mDataProp_3","value":"wjdx"},{"name":"bSortable_3","value":true},{"name":"mDataProp_4","value":"scsj"},{"name":"bSortable_4","value":true},{"name":"mDataProp_5","value":"function"},{"name":"bSortable_5","value":false},{"name":"iSortingCols","value":0},{"name":"wlkcid","value":"${
                  course._courseID}"}]`
        }
      })
      ...
      for (let document of resp.object.aaData) {
        result.push({
          title:
              document.bt.replace(/&ldquo;/gi, '“').replace(/&rdquo;/gi, '”'),
          type: document.wjlx,
          size: document.wjdx,
